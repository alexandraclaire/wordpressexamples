...
<div id="reviews">
	<div id="comments">
		...
		<?php else : ?>
			...
			<p class="woocommerce-noreviews"><?php _e( 'Darn, no reviews yet... Be the first!', 'woocommerce' ); ?></p>
	...
	<?php else : ?>
		...
		<p class="woocommerce-verification-required"><?php _e( 'Sorry, you gotta sign up first', 'woocommerce' ); ?></p>
